...
class InfoPanel extends Component {
  ...
  renderInfoBox = () => {
    ...
    if (this.state.infoOpen == true) {
      return (
        <motion.div 
          className={styles.infoBoxWrapper} 
          initial={this.infoBoxWrapper.initial}
          animate={this.infoBoxWrapper.showing}
          exit={this.infoBoxWrapper.exit}
        >
          <div className={styles.infoBox} style={this.state.warningMode && !this.state.ignoreWarning ? this.infoBoxStyleWarning : this.infoBoxStyle}>
            {this.renderInfoText()}
          ...
          <div className={styles.infoBoxShadow} style={this.infoBoxShadowStyle}></div>
        </motion.div>
      )
    } else {}
  ...
  componentDidMount() {
    ...
    if (this.props.warningMode == true) {
      this.setState({
        infoOpen: true,
        temporaryOpen: true,
        warningMode: true
    ...
    return (
      <div className={styles.infoPanelWrapper}>
        <motion.div
          ...
          whileTap={{scale: 0.95, cursor: 'pointer', rotate: '180deg', transition: {duration: 0.1}}}
        >
          <div className={styles.infoButton} style={this.state.warningMode && !this.state.ignoreWarning ? this.infoButtonStyleWarning : this.infoButtonStyle}>
          ...
          <div className={styles.infoButtonShadow} style={this.infoButtonShadowStyle}></div>
        </motion.div>
