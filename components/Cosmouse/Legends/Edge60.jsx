  ...
  return (
    <svg
      ...
      <g opacity='0.8' filter='url(#filter0_f_2_6)'>
        <path d='M90.25 318L310 98' stroke='#9C9C9C' stroke-width='17.5' />
        <circle cx='310' cy='98' r='50' fill='#9C9C9C' />
        <circle cx='90' cy='318' r='50' fill='#9C9C9C' />
      </g>
      <path d='M90.125 310L309.875 90' stroke='#C7C7C7' stroke-width='17.5' />
